...
char	**ft_split(char const *s, char c)
{
	...
	first = 1;
/*
**Nessa parte a função count_total aloca a memoria para o
**retorno da matriz
*/
	**result = malloc(count_total(*s, c) * sizeof(char *));
/*
** aqui ira percorrer a string procurando as palavras e
**incluindo na matriz
*/
	while (!s[i] == '\0')
	{
...
*/
		if (s[i] == c)
			i++;
/*
** caso seja uma palavra, ele vai alocar espaço na
**memoria e depois
...
/*
** essa função consta quantas letras tem dentro da palavra e retorna a
** quantidade
*/
